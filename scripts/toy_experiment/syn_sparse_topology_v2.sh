...
python -u toy_experiment_related/syn_sparse_topology_generation_v2.py

DATA_PATH=sparse_topo_v2_150.npy
MODEL_ID=syn_sparse_topo_v2_150_experiment
ENC=8
...
# 1) PT + sparse topology prior v2
python -u run.py $COMMON --model PT_syn_sparse_topo_v2
