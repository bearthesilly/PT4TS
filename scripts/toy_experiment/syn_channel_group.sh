...
python -u toy_experiment_related/syn_channel_group_generation.py

DATA_PATH=channel_group_150.npy
MODEL_ID=syn_channel_group_150_experiment
ENC=9
...
# 1) PT + channel grouping prior
python -u run.py $COMMON --model PT_syn_channel_group
