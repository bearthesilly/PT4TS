...
class PtModel(nn.Module):
    def __init__(self, args):
        ...
        self.predict_linear_1 = nn.Linear(
                config.dim_z, args.c_out)
        self.predict_linear_2 = nn.Linear(
    ...
    def forward(
        ...
        dec_out = self.predict_linear_1(qz)  # [bs, length, dim_z]
        dec_out = self.predict_linear_2(dec_out.transpose(1, 2)).transpose(1, 2)  # [bs, pred_len, c_out]
        dec_out = dec_out * \
