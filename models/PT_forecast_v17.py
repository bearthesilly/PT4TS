...
This model supports the switch of rope. In this implementation, the rope for channel is switched off.
'''
import math
import warnings
...
class PtHeadSelection(nn.Module):
    ...
    def calculate_messageF(self, qz, dependency_mask, position_ids, position_embeddings, ternary_factor_u, ternary_factor_v, is_rope):
    ...
    def calculate_messageG(self, qh, qz_uo, qz_v, qz_u, bsz, seq_len, position_ids, position_embeddings, ternary_factor_u, ternary_factor_v, is_rope):
        ...
        if is_rope:
            ...
            if qz_uo is not None:
                raise ValueError("If not using RoPE, qz_uo should be None")
            qh_v1 = torch.matmul(qh, qz_v)
