...
class PTPeriod(nn.Module):
    def __init__(self, args):
        ...
        self.period = 5 # can be modified with inductive bias
        self._lambda = 3
    ...
    def create_decaying_matrix(self, a=0.5, p=2, k=3, scale = 1):
...
class PtEncoderIterator(nn.Module):
    ...
    def forward(
        ...
        # unary potentials
        qz = (m1 + m2 + unary_potentials + period) / self.config.regularize_z
