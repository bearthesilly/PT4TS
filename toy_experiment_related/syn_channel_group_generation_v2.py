...
class ChannelGroupGeneratorV2:
    """
    Synthetic dataset for the Channel Grouping prior (v2).

    9 channels in 3 groups of 3:
        Group A: ch0, ch1, ch2
        Group B: ch3, ch4, ch5
        Group C: ch6, ch7, ch8

    Key design: each channel = shared_group_latent + HEAVY independent noise.
    ...
    A model with group-pooling prior can directly average within-group Z
    representations -> better latent estimate -> better prediction.
    """
    ...
    def generate(self, save_path='./dataset/syn_data/channel_group_v2_150.npy'):
        print(f"Generating {self.num_samples} channel-grouping-v2 samples "
...
if __name__ == "__main__":
    gen = ChannelGroupGeneratorV2(num_samples=150, sample_len=192, seed=2025)
